...
export class GameMenu {
    ...
    createTopSection() {
        ...
        Object.assign(section.style, {
            width: '100%',
            height: '40px', // Manter espaço mas sem conteúdo
            padding: '0 40px'
        });
        return section;
    }
    ...
    showCredits() {
        // NÃO remover o menuContainer do DOM!
        // Apenas limpe o conteúdo do menuContainer
        if (this.menuContainer) {
        ...
        backButton.addEventListener('click', () => {
            // Limpa o conteúdo e recria o menu principal
            this.menuContainer.innerHTML = '';
            this.createMainMenu();
            this.showMenu();
        });
    ...
    dispose() {
        ...
        // Clean up options menu if it exists
        if (this.optionsMenu && this.optionsMenu.container) {
            this.optionsMenu.container.remove();
            this.optionsMenu = null;
        }
